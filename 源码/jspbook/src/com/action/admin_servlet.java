...
public class admin_servlet extends HttpServlet
{
	...
	public void adminMana(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
	{
		...
		String sql="select * from t_admin_pqy";
		Object[] params={};
		DB mydb=new DB();
		try
		{
	...
	public void adminAdd(HttpServletRequest req,HttpServletResponse res)
	{
		...
		String sql="insert into t_admin_pqy(userName,userPw,userRole) values(?,?,?)";
	...
	public void adminDel(HttpServletRequest req,HttpServletResponse res)
	{
		...
		String sql="delete from t_admin_pqy where userId="+Integer.parseInt(req.getParameter("userId"));
		Object[] params={};
		DB mydb=new DB();
		mydb.doPstm(sql, params);
		mydb.closed();
